...
This report was written during the latter half of 2023 and the beginning of 2024. Therefore, any advancements in the artificial neural network field beyond this date are not covered in this report. Readers of this report are free to make an updated version, by accessing the \LaTeX \space open source files. These are available on GitHub at \cite{giovannilin-no-date}. % recompile one final time, upload source files to github and download pdf
